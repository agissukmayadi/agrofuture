...
@section('body')
    ...
    @if (session()->has('toast-success'))
        <div id="toast-success"
            class=" fixed bottom-5 right-5 z-[100] flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
            role="alert">
            <div
    ...
    <div class="fixed z-[100] top-0  left-0 right-0 bottom-0 bg-black/40 hidden items-center justify-center" id="loading">
        <div role="status">
            <svg aria-hidden="true" class="w-10 h-10 text-gray-200 animate-spin  fill-secondary" viewBox="0 0 100 101"
